    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-gray-100 px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center space-y-2">
          ...
          <CardDescription>
            Sistema de Gestión para Talleres de Camperización
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          {!isDemoMode && (
            <div className="mt-6 text-center text-sm text-gray-500">
              <p>Credenciales de Supabase configuradas</p>
              <p className="text-xs mt-1">Usa tu cuenta de Supabase para acceder</p>
            </div>
          )}
        </CardContent>
      </Card>
